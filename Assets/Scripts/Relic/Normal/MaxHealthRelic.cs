...
[CreateAssetMenu(fileName = "MaxHealthRelic", menuName = "Relic/Normal/MaxHealthRelic")]
public class MaxHealthRelic : RelicData
{
    ...
    public override void OnEquip(CharacterBase character)
    {
        ...
        character.characterData.maxHP += relicValue;
    }
