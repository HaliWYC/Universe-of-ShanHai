...
[CreateAssetMenu(fileName = "DrawCardNumRelic", menuName = "Relic/Superior/DrawCardNumRelic")]
public class DrawCardNumRelic : RelicData
{
    ...
    public override void OnEquip(CharacterBase character)
    {
        ...
        character.characterData.cardDrawEachTurn += relicValue;
    }
