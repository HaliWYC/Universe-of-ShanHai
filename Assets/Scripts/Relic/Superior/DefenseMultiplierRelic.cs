...
[CreateAssetMenu(fileName = "DefenseMultiplierRelic", menuName = "Relic/Superior/DefenseMultiplierRelic")]
public class DefenseMultiplierRelic : RelicData
{
    ...
    public override void OnEquip(CharacterBase character)
    {
        ...
        character.characterData.baseDefenseMultiplier += relicValue;
    }
